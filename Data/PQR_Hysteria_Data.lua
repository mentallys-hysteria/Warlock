...
elseif select(2,UnitClass("player")) == "WARLOCK" then
	...
	local config = {
		...
		abilities = {
			{ 	name	= "Soulstone",
				tooltip	= "Select automatic Soulstone usage.",
				enable	= true,
				widget	= { type = "select",
					values	= {
						"Self",
					...
					width	= 100,
					tooltip	= "Select if you only want to Soulstone yourself, your tanks and healers or anyone in your party or raid!",
				},
			},
			{ 	name	= "Healthstone",
				enable	= true,
			...
			{ 	name	= "Summon Pet",
				tooltip	= "Select the pet you want to have summoned. Will automatically summon the equivilent pet when you use Grimoire of Supremacy.",
				enable	= true,
				widget	= { type = "select",
					values	= {
						"Imp",
			...
			{ 	name	= "Grimoire Pet",
				tooltip	= "Select the pet you want to have summoned for your Grimoire spell.",
				enable	= true,
				widget	= { type = "select",
					values	= {
						"Imp",
